        ...
        foreach ($barangays as $barangay) {
            ...
            for ($i = 1; $i <= 2; $i++) {
                ...
                $disb = Disbursement::create([
                    ...
                    'dv_number' => 'DV-25-08-' . str_pad($disbursementIndex, 3, '0', STR_PAD_LEFT),
                    'cheque_number' => '20000' . (150 + $disbursementIndex),
                    'bank_id' => $bankId,
                    'payee' => 'Payee ' . $disbursementIndex,
                    'particular' => 'Honorarium of barangay officials',
                    'tran_appropriations_id' => 1,
                    'dv_amount' => $dvAmount,
                    'status' => 'Liquidated',
            ...
            for ($i = 3; $i <= 4; $i++) {
                ...
                $disb = Disbursement::create([
                    ...
                    'bank_id' => $bankId,
                    'payee' => 'Payee ' . $disbursementIndex,
                    'particular' => 'C/A Honorarium',
                    'tran_appropriations_id' => 2,
                    'dv_amount' => $dvAmount,
                    'status' => 'Pending',
