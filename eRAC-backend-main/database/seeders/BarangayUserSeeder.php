...
class BarangayUserSeeder extends Seeder
{
    public function run()
    {
        ...
        $usersForFirstBarangay = [
            ...
            [
                'username' => strtolower(str_replace(' ', '', $firstBarangay->name)) . '_kagawad',
                'first_name' => 'Kobe Bryant',
                'middle_name' => 'S.',
                'last_name' => 'Tubo',
                'position_name' => 'Barangay Kagawad',
                'email' => strtolower(str_replace(' ', '', $firstBarangay->name)) . '_kagawad@example.com',
            ],
            [
                'username' => strtolower(str_replace(' ', '', $firstBarangay->name)) . '_sk',
                'first_name' => 'Dan Steve',
                'middle_name' => 'P.',
                'last_name' => 'Bermejo',
                'position_name' => 'SK Chairperson',
                'email' => strtolower(str_replace(' ', '', $firstBarangay->name)) . '_sk@example.com',
            ],
            [
                'username' => strtolower(str_replace(' ', '', $firstBarangay->name)) . '_secretary',
                'first_name' => 'Kristine Cielo',
                'middle_name' => 'B.',
                'last_name' => 'Garcia',
                'position_name' => 'Barangay Secretary',
                'email' => strtolower(str_replace(' ', '', $firstBarangay->name)) . '_secretary@example.com',
            ],
            [
