              ...
              <q-step :name="3" title="OTP" icon="verified_user" :done="step > 3">
                <div class="otp-verification-section">
                  ...
                  <div v-if="isSending" class="text-center q-pa-lg">
                    ...
                    <div class="text-subtitle2 text-grey-7 q-mt-sm">Sending OTP, please wait...</div>
                  </div>

                  <!-- Show OTP form when not loading -->
                  <div v-else>
                    <div class="text-center">
                      <div class="text-body2 text-grey-7">We've sent a verification code to:</div>
                      <div class="text-body1 text-weight-medium text-green-8 ">{{ email }}</div>
                    </div>
                    ...
                    <div class="text-center q-mt-md">
                      <div class="text-caption text-grey-6 q-mb-sm">Didn't receive the code?</div>
                ...
                <q-stepper-navigation class="row justify-between q-mt-md">
                  ...
                  <q-btn @click="handleSubmit" color="green" label="Verify & Complete" :disable="isLoading || isSubmitting" />
                </q-stepper-navigation>
              </q-step>
            </q-stepper>
          </q-card>
...
const goToOtp = async () => {
  ...
  try {
    ...
    await api.post('/api/otp/generate', { email: email.value })
...
const handleSubmit = async () => {
  ...
  try {
    ...
    step.value = 1 // reset form (optional: redirect to login)
  } catch (error) {
    $q.notify({
      type: 'negative',
